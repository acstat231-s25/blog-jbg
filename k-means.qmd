...
To observe patterns and relationships amongst the top songs on Spotify, unsupervised learning was utilized through $k$-means analysis. $K$-means analysis includes assigning each track to a distinct group based on similarities in track features.      
