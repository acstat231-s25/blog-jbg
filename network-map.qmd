...
- `rvest` by @tidyverse
- `ggplot2` by @tidyverse
- `stringr` by @tidyverse
- `purrr` by @tidyverse
- `robotstxt` by @petermeissner
- `tidytext` by @juliasilge and @dgrtwo
- `tidyr` by @tidyverse
- `dplyr` by @tidyverse
- `spotifyr` by @charlie86
- `GGally` by @ggobi
- `igraph` by @igraph
- `ggraph` by @thomasp85
- `tidygraph` by @thomasp85
- `sf` by @rspatial
- `httr` by @tidyverse
- `leaflet` by @rstudio
- `ggspatial` by @paleolimbot
- `RColorBrewer` by @rforge
- `kableExtra`by @haozhu233
- `geodata` by @rspatial
- `citation` by @cite  
...
citation ("geodata")
citation ("igraph")
print(citation("igraph"), bibtex = TRUE)
citation ("leaflet")
citation ("kableExtra")
citation ("robotstxt")
citation ("tidytext")
