...
Through exploring this data, we hope you had as much fun as we did leanring new things about Artist and the music industry through connections the artist make. From our interactive map, we hope you can see if you want to make music or become famous it might not be a bad idea to set up shop there, in additiona to the pop genre takeover might even be in your best interest to produce a pop song or two-- while still putting out what you actually want. 

This is a music fact sheet meeant for enegement, entertainment, and information. Whether you are a fan, and inspirirng artist, or just a o
