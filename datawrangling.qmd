...
NumberOfArtisitHits <- as_tbl_graph(x= numberHits, nodes=playlist_genre, edges =  track_artist, directed= FALSE) #Mutually Connected Each Artist Should have a genre (Check that definition)
...
#Will have to sets of datasets to use 
#These are the sets to focus on 
Offical_artist_collabset
songs_top100
