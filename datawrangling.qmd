...
#Get rid of artist mentions of themselves and thn removing the column because it does not add any useful information (it just reopeats the artists again)
textspacesallocation1<- textspacesallocation1|>
    filter(!track_artist1== "x")
Offical_artist_collabset<- textspacesallocation1|>
  select( -track_artist1)

          

songs_network <- play_gnp(n, p, directed = FALSE) |>
    # Activate the node list to add numbered labels
    activate(nodes) |>
