...
NumberOfArtisitHits <- as_tbl_graph(x= numberHits, nodes=playlist_genre, edges =  track_artist, directed= FALSE) #Mutually Connected Each Artist Shoould have a genre (Check that defintion)
